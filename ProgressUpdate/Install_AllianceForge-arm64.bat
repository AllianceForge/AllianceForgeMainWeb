...
%ADB% %DEVICE% install AllianceForge-arm64.apk
@if "%ERRORLEVEL%" NEQ "0" goto Error
%ADB% %DEVICE% shell pm list packages com.YourCompany.AllianceForge
...
%ADB% %DEVICE% shell rm -r %STORAGE%/Download/obb/com.YourCompany.AllianceForge
...
%ADB% %DEVICE% shell pm grant com.YourCompany.AllianceForge android.permission.READ_EXTERNAL_STORAGE >nul 2>&1
%ADB% %DEVICE% shell pm grant com.YourCompany.AllianceForge android.permission.WRITE_EXTERNAL_STORAGE >nul 2>&1
