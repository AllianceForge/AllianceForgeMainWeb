    ...
    const FAQModal = ({ onClose, isPageView = false }) => {
      ...
      return (
        <div
          ...
          role="dialog"
          aria-modal="true"
          aria-labelledby="faq-title" // Ensure faq.html has a title with this id
          tabIndex="-1"
          ref={modalRef}
        >
          <div className={frameClass}>
            {/* Using an iframe to load faq.html content */}
            <iframe
              src="./faq.html" // This is where the faq.html file will be loaded from
