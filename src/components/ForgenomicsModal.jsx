...
const ForgenomicsModal = ({ onClose, isPageView = false }) => {
  ...
  return (
    <div
      ...
      role="dialog"
      aria-modal="true"
      aria-labelledby="forgenomics-title" // Ensure forgenomics.html has a title with this id
      tabIndex="-1"
      ref={modalRef}
    >
      <div className={frameClass}>
        {/* Using an iframe to load forgenomics.html content */}
        <iframe
          src="./forgenomics.html" // This is where the forgenomics.html file will be loaded from
          title="Forgenomics Document"
