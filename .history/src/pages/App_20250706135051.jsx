...
const App = () => {
  ...
  const [isWhitepaperOpen, setIsWhitepaperOpen] = useState(false); // State for modal
  ...
  return (
    <Router>
      <div className="min-h-screen relative">
        ...
        <Navbar setIsWhitepaperOpen={setIsWhitepaperOpen} /> {/* Pass modal toggle */}
        ...
        {mobileDrawerOpen && (
          <div className="fixed inset-0 z-30 bg-black bg-opacity-50 md:hidden">
            ...
            <div className="bg-gray-800 p-4">
              <Navbar setIsWhitepaperOpen={setIsWhitepaperOpen} />
            </div>
          </div>
        )}
