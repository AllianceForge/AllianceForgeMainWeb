  ...
  return (
    <div className="min-h-screen bg-gray-900 text-white flex flex-col items-center justify-center px-6 py-12">
      ...
      <div className="mt-2 mb-6">
        ...
        >
          <img
            src="/assets/crypto-com-otro.webp"
            alt="Crypto.com NFT"
            className="h-20 md:h-28 mx-auto transition-transform duration-300 hover:scale-110 drop-shadow-md"
          />
        </a>
        <p className="text-center text-sm text-cyan-300 mt-2 tracking-wide italic">
