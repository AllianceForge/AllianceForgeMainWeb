...
const WhitepaperModal = ({ onClose, isPageView = false }) => {
  ...
  return (
    <div
      ...
      role="dialog"
      aria-modal="true"
      aria-labelledby="whitepaper-title" // Ensure whitepaper.html has a title with this id
      tabIndex="-1"
      ref={modalRef}
    >
      <div className={frameClass}>
        {/* Using an iframe to load whitepaper.html content */}
        <iframe
          src="./whitepaper.html" // This is where the whitepaper.html file will be loaded from
...
WhitepaperModal.propTypes = {
  ...
  isPageView: PropTypes.bool, // Corrected PropTypes.func to PropTypes.bool
};
