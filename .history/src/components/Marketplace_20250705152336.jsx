const Marketplace = () => {
  return (
    <div className="min-h-screen bg-gray-900 text-white flex flex-col items-center justify-center px-6 py-12">
      ...
      {/* Custom Crypto.com | NFT Logo */}
      <div className="mt-4 mb-8">
        <img
          src="/assets/crypto-com-otro.webp"
          alt="Crypto.com NFT Logo"
          className="h-20 md:h-28 mx-auto object-contain drop-shadow-lg transition-transform duration-300 hover:scale-105"
        />
      </div>
