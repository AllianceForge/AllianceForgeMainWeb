...
// Note: Ensure that the `navItems` in your constants file is updated to match the new structure and order.
// This file defines the Navbar component, which includes navigation links and a mobile drawer.