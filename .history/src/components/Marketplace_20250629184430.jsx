  ...
  return (
    <div className="min-h-screen bg-gray-900 text-white flex flex-col items-center justify-center px-6">
      ...
      <div className="mb-6 mt-4">
        ...
        >
          <img
            src="/assets/crypto-nft-blue.png" // Asegúrate de que este archivo esté en tu carpeta /public/assets/
            alt="Crypto.com NFT"
            className="h-20 mx-auto transition-transform duration-300 hover:scale-105 drop-shadow-[0_0_12px_rgba(0,174,239,0.7)]"
          />
        </a>
