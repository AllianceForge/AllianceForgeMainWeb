              ...
              <Route
                ...
                element={
                  <div className="max-w-7xl mx-auto pt-20 px-6">
                    ...
                    {/* The Forgenomics and FAQ sections are here, but they will not be used to show content anymore. */}
                    {/* They will just be anchor points for on-page navigation if you want to keep that functionality. */}
                    <div id="forgenomics">
                      <ForgenomicsSection />
                    </div>
                    <div id="faq">
