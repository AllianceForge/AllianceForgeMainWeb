...
const App = () => {
  ...
  // ✅ Remove delay, set appReady immediately
  useEffect(() => {
    setAppReady(true);
  }, []);
  ...
  return (
    <Router>
      <div className="min-h-screen relative">
        {/* ✅ Optimize video loading with smaller file or faster preload */}
        <video
          src={video}
          autoPlay
          loop
          muted
          playsInline
          preload="metadata" // Ensures metadata loads quickly
        ...
        {/* ✅ Render navbar and button as soon as possible */}
        {appReady && (
          <>
            <Navbar />
